...
namespace Rebus.AdoNet
{
	public abstract class DatabaseFixtureBase : FixtureBase, IDetermineMessageOwnership
	{
		...
		private static string GetPostgresConnectionString()
		{
			...
			return "User ID=postgres;Password=Password12!;Host=localhost;Port=5432;Database=test;Pooling=true;Min Pool Size=0;Max Pool Size=100;Connection Lifetime=0;";
		}
